...
(function() {
    ...
    var G = function(a, b, c) {
        ...
        K = function(a, b, c) {
            b && 0 < b.length && (b = J(b), c && 0 < c.length && (b += "___" + J(c)), 28 < b.length && (b = b.substr(0, 28) + (b.length - 28)), c = b, b = u(ca, "_p", w()), u(b, c, w())[a] = (new Date)
                .getTime(), G(a, "_p", c))
        },
        J = function(a) {
            return a.join("__")
    ...
    var da = /^(\/[a-zA-Z0-9_\-]+)+$/,
        ...
        na = function(a, b, c, d) {
            ...
            return [encodeURIComponent(a.pathPrefix)
                .replace(/%2C/g, ",")
                .replace(/%2F/g, "/"), "/k=", e(a.version), "/m=", e(b), d ? "/exm=" + e(d) : "", "/rt=j/sv=1/d=1/ed=1", a.a ? "/am=" + e(a.a) : "", a.c ? "/rs=" + e(a.c) : "", a.f ? "/t=" + e(a.f) : "", "/cb=", e(c)
            ].join("")
        },
        ma = function(a) {
    ...
    var R = decodeURI("%73cript"),
        ...
        U = function() {
            var a = A.nonce;
            if (void 0 !== a) return a && a === String(a) && a.match(S) ? a : A.nonce = null;
            var b = u(A, "us", []);
        ...
        V = function(a) {
            ...
            b.async = "true";
            (a = h.getElementsByTagName(R)[0]) ? a.parentNode.insertBefore(b, a): (h.head || h.body || h.documentElement)
                .appendChild(b)
        },
        qa = function(a,
            b) {
    ...
    F.bs0 = window.gapi._bs || (new Date)
        .getTime();
    G("bs0");
    F.bs1 = (new Date)
        .getTime();
...
gapi.load("client", {
    ...
    _c: {
        "jsl": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en.wLZo7B58NJ4.O/m\u003d__features__/am\u003dAQE/rt\u003dj/d\u003d1/rs\u003dAGLTcCMCCijGjxSiielcxT7UGVLcRNzbkg",
