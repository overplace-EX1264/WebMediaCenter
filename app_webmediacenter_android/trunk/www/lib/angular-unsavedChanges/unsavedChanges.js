...
.service('unsavedWarningSharedService', ['$rootScope', 'unsavedWarningsConfig', '$injector', '$window', '$ionicPopup', '$ionicHistory',
    function($rootScope, unsavedWarningsConfig, $injector, $window, $ionicPopup, $ionicHistory) {
                ...
                var removeFn = $rootScope.$on(aEvent, function(event, next, current) {
                    ...
                    if (!allFormsClean()) {
                        ...
                        var confirmPopup = $ionicPopup.confirm({
                			title: 'Attenzione',
                            template: unsavedWarningsConfig.navigateMessage,
                            okText: 'Si',
                            cancelText : 'No'
                        });
